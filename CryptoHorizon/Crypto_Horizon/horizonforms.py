...
class RegistrationForm(FlaskForm):
    ...
    address = StringField('ETH Wallet address', validators=[DataRequired()])
...
class TransferForm(FlaskForm):
    amount = IntegerField('Amount - ETH', validators=[DataRequired()])
    receiving_username = StringField('Username of Account You Wish To Send To', validators=[DataRequired()])
    private_keys = StringField('Private key ',validators=[DataRequired()])
    password = PasswordField('Password', validators=[DataRequired()])
